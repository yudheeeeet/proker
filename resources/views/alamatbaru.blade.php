                            ...
                            <div class="row align-items-center">
                                <div class="col-xl-8 col-xxl-12">
                                    <div class="text-center text-xl-left text-xxl-center px-4 mb-4 mb-xl-0 mb-xxl-4">
                                        ...
                                        <form action="{{url('tambah-data-alamat')}}" method="POST" enctype="multipart/form-data">
                                            @csrf
                ...
                <div class="col-xxl-12 col-xl-12 mb-4">
                    <div class="card card-header-actions h-100">
                        ...
                        <div id="mapid" style="height: 700px" >
                            <script>
                            var mymap = L.map('mapid').setView([-8.1704196, 113.707464], 18);
                            ...
                            var curLocation = [-8.170504799351134, 113.710116147995];
